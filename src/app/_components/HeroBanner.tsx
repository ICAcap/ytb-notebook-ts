		...
		>
			<div className="mx-auto grid max-w-[1800px] grid-cols-1 items-center gap-16 px-4 py-28 sm:px-6 sm:py-36 lg:grid-cols-12 lg:gap-8 lg:px-8 xl:px-12">
				<div className="text-center lg:col-span-3 lg:text-left">
					...
					<h1 className="mt-8 text-6xl font-bold tracking-tight text-base-content sm:text-7xl lg:text-5xl xl:text-6xl">
				...
				<div className="overflow-hidden rounded-2xl border border-base-300 shadow-2xl shadow-primary/20 ring-1 ring-base-content/5 lg:col-span-9 lg:ml-auto">
					<img
